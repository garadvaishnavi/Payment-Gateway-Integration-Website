...
<div class="input-group-text"><i class="fa fa-user text-info"></i><label> Name:</label></div>
<div class="input-group-text"><i class="fa fa-envelope text-info"></i><label> Email:</label></div>
<div class="input-group-text"><i class="fa fa-comment text-info"></i><label> Message:</label></div>
